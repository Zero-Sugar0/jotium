...
export async function GET(
  ...
  switch (service) {
    ...
    case "zoom":
      ...
      // Zoom OAuth scopes for comprehensive meeting and webinar management
      scope = [
        "meeting:read:admin",
        "meeting:write:admin",
        ...
        "meeting:share:admin",
        "meeting:live_stream:admin",
        "meeting:recording:read:admin",
        "meeting:recording:write:admin",
        "meeting:recording:update:admin",
        "meeting:recording:delete:admin",
        "meeting:recording:share:admin",
        "meeting:registration:read:admin",
        "meeting:registration:write:admin",
        "meeting:registration:update:admin",
        "meeting:registration:delete:admin",
        "meeting:registration:share:admin",
        "meeting:poll:read:admin",
        "meeting:poll:write:admin",
        "meeting:poll:update:admin",
        "meeting:poll:delete:admin",
        "meeting:poll:share:admin",
        "meeting:qa:read:admin",
        "meeting:qa:write:admin",
        "meeting:qa:update:admin",
        "meeting:qa:delete:admin",
        "meeting:qa:share:admin",
        "meeting:report:read:admin",
        "meeting:report:write:admin",
        "meeting:report:update:admin",
        "meeting:report:delete:admin",
        "meeting:report:share:admin",
        "meeting:settings:read:admin",
        "meeting:settings:write:admin",
        "meeting:settings:update:admin",
        "meeting:settings:delete:admin",
        "meeting:settings:share:admin",
        "meeting:template:read:admin",
        "meeting:template:write:admin",
        "meeting:template:update:admin",
        "meeting:template:delete:admin",
        "meeting:template:share:admin",
        "webinar:read:admin",
        "webinar:write:admin",
        "webinar:update:admin",
        "webinar:delete:admin",
        "webinar:share:admin",
        "webinar:recording:read:admin",
        "webinar:recording:write:admin",
        "webinar:recording:update:admin",
        "webinar:recording:delete:admin",
        "webinar:recording:share:admin",
        "webinar:registration:read:admin",
        "webinar:registration:write:admin",
        "webinar:registration:update:admin",
        "webinar:registration:delete:admin",
        "webinar:registration:share:admin",
        "webinar:poll:read:admin",
        "webinar:poll:write:admin",
        "webinar:poll:update:admin",
        "webinar:poll:delete:admin",
        "webinar:poll:share:admin",
        "webinar:qa:read:admin",
        "webinar:qa:write:admin",
        "webinar:qa:update:admin",
        "webinar:qa:delete:admin",
        "webinar:qa:share:admin",
        "webinar:report:read:admin",
        "webinar:report:write:admin",
        "webinar:report:update:admin",
        "webinar:report:delete:admin",
        "webinar:report:share:admin",
        "webinar:settings:read:admin",
        "webinar:settings:write:admin",
        "webinar:settings:update:admin",
        "webinar:settings:delete:admin",
        "webinar:settings:share:admin",
        "webinar:template:read:admin",
        "webinar:template:write:admin",
        "webinar:template:update:admin",
        "webinar:template:delete:admin",
        "webinar:template:share:admin",
        "user:read:admin",
        "user:write:admin",
        "user:update:admin",
        "user:delete:admin",
        "user:share:admin",
        "user:settings:read:admin",
        "user:settings:write:admin",
        "user:settings:update:admin",
        "user:settings:delete:admin",
        "user:settings:share:admin",
        "user:profile:read:admin",
        "user:profile:write:admin",
        "user:profile:update:admin",
        "user:profile:delete:admin",
        "user:profile:share:admin",
        "account:read:admin",
        "account:write:admin",
        "account:update:admin",
        "account:delete:admin",
        "account:share:admin",
        "account:settings:read:admin",
        "account:settings:write:admin",
        "account:settings:update:admin",
        "account:settings:delete:admin",
        "account:settings:share:admin",
        "report:read:admin",
        "report:write:admin",
        "report:update:admin",
        "report:delete:admin",
        ...
        "dashboard:share:admin"
      ].join(" ");
      
      if (!clientId) {
        console.error("ZOOM_CLIENT_ID environment variable is not set.");
        return new Response("Zoom OAuth configuration error", { status: 500 });
      }
      ...
      authorizationUrl = `https://zoom.us/oauth/authorize?${zoomParams.toString()}`;
      break;

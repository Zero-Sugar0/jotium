...
export class AyrshareSocialTool implements Tool {
  ...
  getDefinition(): FunctionDeclaration {
    return {
      name: "social_media",
      description: "Advanced comprehensive enterprise-grade social media management and automation platform using Ayrshare API for complete social media content creation, scheduling, analytics, and engagement across 15+ major platforms. Create sophisticated social media campaigns with intelligent content optimization, automated scheduling, and multi-platform publishing across Facebook, Instagram, Twitter/X, LinkedIn, TikTok, YouTube, Pinterest, Reddit, Discord, Telegram, Snapchat, WhatsApp Business, and emerging platforms. Manage comprehensive content workflows with bulk posting, queue management, content recycling, and dynamic content generation with AI-powered hashtag suggestions and link shortening. Implement advanced scheduling with optimal timing algorithms, timezone-aware posting, recurring schedules, and auto-scheduling based on audience engagement patterns. Monitor real-time analytics with detailed engagement metrics, audience insights, performance tracking, and competitor analysis across all connected platforms. Handle interactive engagement with comment management, automated replies, direct messaging, and social listening capabilities. Create targeted advertising campaigns with audience segmentation, budget optimization, A/B testing, and conversion tracking. Perfect for social media managers, marketing agencies, content creators, enterprises, and businesses requiring sophisticated social media automation, comprehensive platform management, and intelligent content strategy optimization across multiple social networks with unified dashboard control and enterprise-grade analytics.",
      parameters: {
        type: Type.OBJECT,
        properties: {
          action: {

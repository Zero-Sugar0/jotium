...
export class AlphaVantageTool implements Tool {
  ...
  getDefinition(): FunctionDeclaration {
    return {
      name: "financial_data",
      description: "Complete financial market data and investment analysis platform providing real-time and historical data for comprehensive market research and trading decisions. Access real-time stock quotes, intraday price data with customizable time intervals (1min, 5min, 15min, 30min, 60min), daily/weekly/monthly historical price data, and adjusted stock prices. Analyze company fundamentals with earnings data, company overviews, income statements, balance sheets, cash flow statements, IPO calendars, and listing/delisting information. Perform technical analysis with 50+ indicators including moving averages (SMA, EMA), momentum indicators (RSI, MACD, Stochastic), trend indicators (ADX, Aroon), volatility indicators (Bollinger Bands, ATR), volume indicators (OBV, AD), and advanced indicators (VWAP, CCI, Williams %R). Monitor forex markets with real-time exchange rates, intraday/daily/weekly/monthly forex data, and currency pair analysis. Track cryptocurrency markets with digital currency ratings, intraday/daily/weekly/monthly crypto data, and Bitcoin/Ethereum analysis. Access commodity markets including WTI/Brent crude oil, natural gas, metals (copper, aluminum), and agricultural products (wheat, corn, cotton, sugar, coffee). Monitor economic indicators including GDP, treasury yields, federal funds rate, CPI inflation, retail sales, unemployment, and nonfarm payroll. Analyze market sentiment with sector performance, top gainers/losers, most active stocks, insider transactions, and news sentiment analysis. Optimize portfolios with asset allocation and portfolio optimization tools. Perfect for financial analysts, traders, investors, researchers, and developers building financial applications, trading algorithms, investment platforms, and market analysis tools.",
      parameters: {
        type: Type.OBJECT,
        properties: {
          action: {
